...
public class Tech_View : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        tower_name_1.AddRange(new List<Button> {tower_name0, tower_name1, tower_name2, tower_name3, tower_name4, tower_name5, tower_name6, tower_name7});
        tower_text_1.AddRange(new List<Text> {tower_text0, tower_text1, tower_text2, tower_text3, tower_text4, tower_text5, tower_text6, tower_text7});
        tower_name_2.AddRange(new List<Button> {tower_name8, tower_name9, tower_name10, tower_name11});
        tower_text_2.AddRange(new List<Text> {tower_text8, tower_text9, tower_text10, tower_text11});
        tower_name_3.AddRange(new List<Button> {tower_name12, tower_name13, tower_name14, tower_name15});
        tower_text_3.AddRange(new List<Text> {tower_text12, tower_text13, tower_text14, tower_text15});
        ...
        public_name_2.AddRange(new List<Button> {public_name12, public_name13, public_name14, public_name15, public_name16, public_name17,
                            public_name18, public_name19});
        public_text_2.AddRange(new List<Text> {public_text12, public_text13, public_text14, public_text15, public_text16, public_text17, public_text18, public_text19});
        
        weapon_name_1.AddRange(new List<Button> { weapon_name0, weapon_name1, weapon_name2, weapon_name3, weapon_name4, weapon_name5, weapon_name6, weapon_name7});
        weapon_text_1.AddRange(new List<Text> {weapon_text0, weapon_text1, weapon_text2, weapon_text3, weapon_text4, weapon_text5, weapon_text6, weapon_text7});
        weapon_name_2.AddRange(new List<Button> {weapon_name8, weapon_name9, weapon_name10, weapon_name11});
        weapon_text_2.AddRange(new List<Text> {weapon_text8, weapon_text9, weapon_text10, weapon_text11});
        weapon_name_3.AddRange(new List<Button> {weapon_name12, weapon_name13});
        weapon_text_3.AddRange(new List<Text> {weapon_text12, weapon_text13});
    }
